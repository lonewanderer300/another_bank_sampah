...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Okt 2025 pada 05.32
-- Versi server: 8.4.3
-- Versi PHP: 7.4.33
...
INSERT INTO `iuran` (`id_iuran`, `id_nasabah`, `biaya`, `deadline`, `status_iuran`) VALUES
(1, 1, 18000, '2025-11-17', 'belum bayar');
...
(9, 'fatih', 'fatihfernandooo@gmail.com', 'fatihfernandooo', '$2y$10$JFLMe9BogfrY.ukQ/TTzHuB/.WYf9OnrjPcMklMTrravKSCzMSlKi', 'user', 'https://ui-avatars.com/api/?name=fatits', '087749933085', '', -1.99138590, 114.79494095, '', 4, 255000.00, 255000.00, '2025-10-11 03:28:07'),
...
(17, 'akutolol', 'tt@kecil.com', NULL, '$2y$10$0DizbAcH7wsbQzTA9EqEX..YHxncQzsBax6r.dy.b3Ub5Wqq5LYsW', 'user', NULL, '123', '', -1.80926765, 114.77777059, '', 5, 0.00, 0.00, '2025-10-30 03:38:40');
...
--
ALTER TABLE `iuran`
  MODIFY `id_iuran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `nasabah`
  MODIFY `id_nasabah` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `rekening_user`
  MODIFY `id_rekening_user` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `transaksi_setoran`
  MODIFY `id_setoran` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
